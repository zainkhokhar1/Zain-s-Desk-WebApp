...
const TodoStatusCard = ({ data }) => {
  const { title, value, percentage, image, color } = data;

  return (
    <div
      className="w-full col-span-4 h-40 rounded-xl border border-white/20 p-4 flex flex-col justify-between relative"

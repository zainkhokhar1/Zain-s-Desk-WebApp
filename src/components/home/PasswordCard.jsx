...
const PasswordCard = ({
  ...
  if (variant === "add-new") {
    return (
      <div 
        onClick={onClick}
        className="bg-[#2C2C2C] hover:bg-[#3A3A3A] transition-all border border-dashed border-white/30 rounded-lg col-span-2 h-33 p-2 flex flex-col justify-around items-center cursor-pointer"
      >
